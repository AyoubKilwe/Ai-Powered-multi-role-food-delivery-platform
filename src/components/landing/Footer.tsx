        ...
        <div className="grid gap-12 md:grid-cols-4">
          <div className="md:col-span-2">
            ...
            <p className="mt-4 max-w-sm text-sm leading-relaxed">
              Borama&apos;s premier food delivery platform. Order from top
              restaurants, track live, book tables, and get AI-powered
              recommendations.
            </p>
          </div>
          <div>
            ...
            <ul className="mt-4 space-y-2 text-sm">
              ...
              <li>
                <Link href="/#how-it-works" className="hover:text-brand-400">
                  How it works
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3 text-sm">
              <li className="flex items-center gap-2">
                <MapPin className="h-4 w-4 shrink-0" /> Borama, Somaliland
              </li>
              <li className="flex items-center gap-2">
                <Phone className="h-4 w-4 shrink-0" /> +252 63 000 0000
              </li>
              <li className="flex items-center gap-2">
                <Mail className="h-4 w-4 shrink-0" /> support@boramafood.com
              </li>
            </ul>
          </div>
        </div>
        <div className="mt-12 border-t border-stone-800 pt-8 text-center text-sm">
          © {new Date().getFullYear()} Borama Food Delivery. All rights
          reserved.
        </div>
      </div>
    </footer>
