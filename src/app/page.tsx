...
import { FloatingHomeSupport } from "@/components/FloatingHomeSupport";
    ...
    <div className="min-h-screen bg-stone-950">
      ...
      <section className="relative flex min-h-screen items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-5xl px-4 pt-24 text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-stone-200 sm:text-xl">
            Order from top restaurants, track your driver live, book a table, or
            ask our AI what to eat tonight.
          </p>
          <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
            <Link href="/register">
              <Button
                size="lg"
                className="min-w-50 text-base shadow-xl shadow-orange-600/30"
              >
            ...
            <Link href="/login">
              <Button
                variant="outline"
                size="lg"
                className="min-w-50 border-white/40 bg-white/10 text-base text-white hover:bg-white/20"
              >
                Sign In
              </Button>
            </Link>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-3 text-stone-400">
              Trending dishes from our partner restaurants
            </p>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mx-auto mt-3 max-w-xl text-stone-400">
              From choosing your meal to smiling at the table — four simple
              steps.
            </p>
          </div>
      ...
      <section id="features" className="relative py-24">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mx-auto mt-3 max-w-2xl text-center text-stone-400">
            Customers, drivers, restaurants, and admins — each with a powerful
      ...
      >
        ...
        <Image
          ...
          loading="lazy"
        />
        <div className="absolute inset-0 bg-linear-to-b from-stone-950/90 via-stone-950/95 to-stone-950" />
        ...
        <div className="relative z-10 mx-auto max-w-3xl px-4 sm:px-6">
          <div className="rounded-3xl border border-stone-700 bg-stone-900 px-8 py-12 text-center shadow-2xl sm:px-12 sm:py-14">
            ...
            <p className="mx-auto mt-5 max-w-xl text-lg leading-relaxed text-stone-300">
              Join thousands enjoying smarter food delivery with live tracking
              and AI recommendations.
            </p>
            <Link href="/register" className="mt-10 inline-block">
              <Button
                size="lg"
                className="min-w-65 text-lg shadow-lg shadow-brand-600/40"
              >
                Get Started Free
              </Button>
            </Link>
      ...
      <FloatingHomeSupport
        whatsappNumber="+2520636279674"
        defaultTitle="Food AI & Support"
      />
