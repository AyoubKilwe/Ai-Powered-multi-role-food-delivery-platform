...
export default function CustomerHomeClient({
  ...
  const [restaurants, setRestaurants] =
    useState<RestaurantSummary[]>(initialRestaurants);
  const [search, setSearch] = useState("");
  const [minRating, setMinRating] = useState("");
  const [maxPrice, setMaxPrice] = useState("");
  const [maxDelivery, setMaxDelivery] = useState("");
  const [profile] = useState<ProfileSummary>(initialProfile);
  ...
  }, [search, minRating, maxPrice, maxDelivery]);
      ...
      <div className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
        ...
        <div className="grid gap-4 sm:grid-cols-3 lg:grid-cols-1">
          ...
          <div className="rounded-2xl border border-stone-200 bg-white p-5 shadow-sm">
            ...
            <p className="mt-2 text-sm text-stone-500">
              Restaurants in Borama, sorted by nearest first.
            </p>
          </div>
          <div className="rounded-2xl border border-stone-200 bg-white p-5 shadow-sm">
      ...
      <div className="rounded-2xl border border-stone-200 bg-white p-5 shadow-sm">
        ...
        <div className="grid gap-4 lg:grid-cols-6">
          ...
          <select
            ...
            className="rounded-xl border border-stone-200 px-4 py-3 lg:col-span-1"
          >
          ...
          >
            <option value="">Qiimo kasta</option>
            <option value="3">Kayar $3</option>
            <option value="5">Kayar $5</option>
            <option value="10">Kayar $10</option>
          </select>
          <select
            value={maxDelivery}
